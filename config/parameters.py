...
OUTPUT_MASK_PATH = "../lithography_simulation_Hopkins/data/output/optimized_mask_gcd_45nm_origin_01_momentum.png"
RESULTS_IMAGE_PATH = "../lithography_simulation_Hopkins/data/output/results_comparison_gcd_45nm_origin_01_momentum.png"
FITNESS_PLOT_PATH = "../lithography_simulation_Hopkins/data/output/fitness_evolution_gcd_45nm_origin_01_momentum.png"
