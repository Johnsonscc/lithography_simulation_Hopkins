...
OUTPUT_MASK_PATH = "../lithography_simulation_Hopkins/data/output/optimized_mask_t100_inverse_momentum.png"
RESULTS_IMAGE_PATH = "../lithography_simulation_Hopkins/data/output/results_comparison_t100_inverse_momentum.png"
FITNESS_PLOT_PATH = "../lithography_simulation_Hopkins/data/output/fitness_evolution_t100_inverse_momentum.png"
