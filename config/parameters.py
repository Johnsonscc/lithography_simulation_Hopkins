...
OUTPUT_MASK_PATH = "../lithography_simulation_Hopkins/data/output/test/optimized_mask_cell160.png"
RESULTS_IMAGE_PATH = "../lithography_simulation_Hopkins/data/output/test/results_comparison_cell160.png"
FITNESS_PLOT_PATH = "../lithography_simulation_Hopkins/data/output/test/fitness_evolution_cell160.png"
